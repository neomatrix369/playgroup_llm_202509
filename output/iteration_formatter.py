...
class IterationStatusFormatter:
    ...
    @staticmethod
    def format_status(ran_all_correctly: bool, ran_at_least_one_correctly: bool) -> Tuple[str, str]:
    ...
    @staticmethod
    def format_summary_status(all_correct_rate: float, at_least_one_rate: float) -> Tuple[str, str]:
