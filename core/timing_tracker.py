...
class TimingTracker:
    ...
    def format_global_start(self) -> str:
        ...
        if self._global['start'] == 0:
            return "Not started"
        return datetime.fromtimestamp(self._global['start']).strftime('%Y-%m-%d %H:%M:%S')
    ...
    def record_individual_duration(self, template: str, problem: str, duration: float) -> None:
        """
    ...
    def record_problem_duration(self, template: str, problem: str, duration: float) -> None:
        """
